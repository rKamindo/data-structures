...
public class BinarySearchTree <T extends Comparable> {
    ...
    public boolean add(T elem) {
        ...
        // binary tree, if it does not ignore adding it
        if (contains(elem)) {
            return false;
        }
    ...
    // Remove a value form this binary tree, if it exists
    ...
    private Node remove(Node node, T elem) {
        ...
        // Found the node we wish to remove
            ...
            // traversing as far left in as possible in the right subtree.
